...
// PATCHED (vendor): `enum Class { }` is an empty/uninhabited enum, which triggers
// the future-incompat lint `uninhabited-static` (rust-lang/rust#74840) when used
// as the type of `static _NSConcreteStackBlock: Class` below. The upstream crate
// has not been updated since 2016. Replace the empty enum with an opaque struct
