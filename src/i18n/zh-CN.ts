export default {
  ...
  // ── Local Models（私有智能）──
  'local.title': '私有智能',
  'local.subtitle': '本地部署 GGUF 模型，数据不出本机',
  'local.browse_hf': '浏览 HuggingFace',
  'local.add': '添加权重',
  'local.add_dialog_desc': '选择权重来源',
  ...
  'local.import_src_missing': '请先选择一个本地权重文件',
  'local.import_btn': '导入',
  'local.import_browser_unsupported': '浏览器环境不支持本地导入，请下载桌面应用',
  'local.empty': '还没有本地模型，去 HuggingFace 下载一个吧',
  'local.port': '端口',
  'local.autostart': '自动启动',
