export default {
  ...
  'settings.mcp_websearch.desc': '开启后，/mcp 端点提供 web_search 工具（本地 Bing 网页搜索），代理会从请求里剔除原生 web_search 工具，强制模型走本地 MCP',
  'settings.mcp_websearch.on': '已开启',
  'settings.mcp_websearch.off': '已关闭',

  'settings.mcp_webfetch.title': 'MCP WebFetch',
  'settings.mcp_webfetch.desc': '开启后，/mcp 端点提供 web_fetch 工具（内置 WebView 渲染页面并提取完整正文），代理会从请求里剔除原生 web_fetch 工具，强制模型走本地 MCP',
  'settings.mcp_webfetch.on': '已开启',
  'settings.mcp_webfetch.off': '已关闭',

  'settings.mcp_vision.title': 'MCP WebVision',
  'settings.mcp_vision.desc': '开启后，/mcp 端点提供 web_vision 工具（由下方指定的视觉模型识图），代理会从请求里剥离图片内容，强制模型走本地 MCP',
