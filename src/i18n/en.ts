export default {
  ...
  'providers.plugin_autostart': 'Start with Router',
  'providers.plugin_autostart_tip': 'When enabled, XRL Router launches this plugin gateway on startup',
  'providers.plugin_autostart_failed': 'Failed to toggle companion start: {msg}',
  'providers.plugin_login': 'Sign in',
  'providers.plugin_login_launched': 'Login started — complete it in the browser page that just opened',
  'providers.plugin_login_failed': 'Failed to start login: {msg}',
  'providers.plugin_hosting_no_runtime': 'Requires node & pnpm installed on this machine',
  'providers.plugin_hosting_no_workdir': 'Plugin did not report its project directory',
  ...
  'providerForm.workdir_label': 'Project directory (workdir)',
  'providerForm.workdir_placeholder': 'C:\\path\\to\\plugin-gateway',
  'providerForm.workdir_hint': 'pnpm run serve / login run here on companion start; credentials are held by the plugin',
  ...
  'keys.col_times': 'Created / Updated / Last Used',
  'keys.time_last_used': 'Last Used',
  'keys.time_updated': 'Updated',
  'keys.time_created': 'Created',
  'keys.rename': 'Rename',
  ...
  'local.add': 'Import Weights',
  'local.import_desc': 'Pick a GGUF file from disk to import',
  ...
  'local.status.downloaded': 'Imported',
